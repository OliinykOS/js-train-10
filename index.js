...
function customObjectFromEntries(entries) {
    ...
    if (Array.isArray(entries)) {
        let newArr = entries.map((element) => {
...
function extendAndFreezeObject(obj1, obj2) {
    ...
    if (typeof obj1 == "object" && typeof obj2 == "object") {
        ...
        Object.freeze(resObj);
        if (Object.isFrozen(resObj)) {
            return resObj;
        } else {
            return "error";
        }
...
function keysAndValues(obj) {
    ...
    if (typeof obj == "object") {
        ...
        return Array.of(keyArray, valueArray);
    } else {
        return null;
    }
}
...
function filterObjectsByKey(arr, key) {
    ...
    if (Array.isArray(arr)) {
        return arr.filter((element) => element.hasOwnProperty(key));
    } else {
        return [];
    }
}
...
function checkOwnership(obj1, obj2, key) {
    ...
    if (obj1.hasOwnProperty(key) && obj2.hasOwnProperty(key)) {
        return Object.is(obj1.value, obj2.value);
    } else {
        return false;
    }
}
...
function getObjectValuesSum(obj) {
    ...
    // Повертаємо суму
    if (typeof obj == "object") {
        return Object.values(obj).reduce((sum, element) => (sum += element), 0);
    } else {
        return 0;
    }
}
